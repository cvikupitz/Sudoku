...
public class GUIColors {
    ...
    /* Bright green color used for the highlighting feature */
    protected static final Color GREEN = new Color(51, 220, 51);

    /* Dark green color used for displaying 'complete' in the status box when user completes a puzzle */
    protected static final Color DARK_GREEN = new Color(0, 175, 0);

    /* Blue color used for coloring editable tiles in the Sudoku puzzle */
    protected static final Color BLUE = new Color(0, 51, 190);

    /* Red color used for coloring illegally inserted numbers */
    ...
    /* A light-blue color used for coloring the background of a Sudoku puzzle */
    protected static final Color BACKGROUND = new Color(204, 204, 255);

    /* A yellowish color used for coloring the background of the menus */
